        ...
        <CardContent className="p-4 sm:p-5">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className={cn(
              ...
              tone === 'raw' && 'bg-slate-100 text-slate-600 border-slate-200',
              tone === 'success' && 'bg-emerald-50 text-emerald-700 border-emerald-200',
              tone === 'review' && 'bg-amber-50 text-amber-700 border-amber-200'
            )}>
                        ...
                        <TableCell>
                          {item.manufacturer_name ? (
                            <div className="space-y-0.5">
                              <span className="text-xs font-bold text-slate-800 block">{item.manufacturer_name}</span>
                              {item.brand_name && (
                                <span className="text-[11px] text-indigo-600 block">Brand: {item.brand_name}</span>
                              )}
                            </div>
                          ) : (
                            <span className="text-xs text-slate-400 italic">Not cleaned yet</span>
                          )}
                        </TableCell>
